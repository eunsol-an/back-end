	...
	<div class="card mt-4">
		<div class="card-body p-5">
			...
			<div class="card-text">
				...
				<div class="d-flex">
				<a href="/member/list?email=${mvo.email }&pageNo=${pgvo.pageNo }&qty=${pgvo.qty }&type=${pgvo.type }&kw=${pgvo.kw }" class="btn btn-primary me-3">Member
					List</a>
				<a href="/member/modify?email=${mvo.email }&pageNo=${pgvo.pageNo }&qty=${pgvo.qty }&type=${pgvo.type }&kw=${pgvo.kw }" class="btn btn-primary me-3">Member
					Modify</a>
