      ...
      <div class="col-xl-6 offset-xl-3">
        <div class="text-box mt-5 mb-5">
          <p class="mb-4">
            ...
            up? Then just <a class="blue" href="/mem/login">log in</a>
          </p>
          ...
          <form action="/mem/update" method="post">
            <div class="mb-4 form-floating">
              <input type="email" class="form-control" id="floatingInput"
                value="${mvo.email }" name="email" readonly> <label
                for="floatingInput">Email address</label>
            </div>
            <div class="mb-4 form-floating">
              <input type="text" class="form-control" id="floatingInput2"
                value="${mvo.nick_name }" name="nick_name" required> <label for="floatingInput">Your
                Nick Name</label>
            </div>
            <div class="mb-4 form-floating">
            ...
            <div class="mb-4 form-floating">
              <input type="text" class="form-control" id="floatingInput"
                value="${mvo.grade }" name="grade"> <label
                for="floatingInput">Your Grade</label>
            </div>
