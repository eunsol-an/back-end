          ...
          <form action="/pd/update" method="post">
           <div class="mb-4 form-floating">
              <input type="text" class="form-control" id="floatingInput"
                placeholder="pno" name="pno" value="${pvo.pno }" readonly>
                <label for="floatingInput">pno</label>
            </div>
            <div class="mb-4 form-floating">
              <input type="text" class="form-control" id="floatingInput"
                placeholder="pname" name="pname" value="${pvo.pname }" required>
                <label for="floatingInput">Product Name</label>
            </div>
            <div class="mb-4 form-floating">
              <input type="text" class="form-control" id="floatingInput2"
                placeholder="price" name="price" value="${pvo.price }" required>
                <label for="floatingInput2">Price</label>
            </div>
            <div class="mb-4 form-floating">
              <input type="text" class="form-control" id="floatingInput3"
                placeholder="madeby" name="madeby" value="${pvo.madeby }" required>
