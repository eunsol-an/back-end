...
// \.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\06_final_jsp_fileUpload\_fileUpload
		...
		case "list":
			...
			break;
		case "search":
			log.info(">>> keyword {}", req.getParameter("keyword"));
			log.info(">>> range {}", req.getParameter("range"));
			req.setAttribute("list", bsv.search(req.getParameter("keyword"), req.getParameter("range")));
